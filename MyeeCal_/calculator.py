...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value=''
        Entry(width=17,bg='#ccddff',font=('Arial Bond',28),textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11,height=4,text='_',relief='flat',bg='white',command=lambda:self.show('-')).place(x=270,y=200)
